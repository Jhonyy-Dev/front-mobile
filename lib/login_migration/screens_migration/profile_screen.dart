...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _cargarDatosUsuario() async {
    ...
    try {
      ...
      if (perfilData != null) {
        setState(() {
          // Usar datos del perfil para la información detallada
          ...
          direccion = perfilData['direccion'] ?? 'Sin dirección';
          ...
          print("✅ Datos de usuario cargados en Profile: $nombreUsuario");
        ...
        // Si no hay datos del perfil pero sí de SharedPreferences
        setState(() {
          nombreUsuario = nombreGuardado;
          imagenUrl = imagenGuardada ?? '';
          print("✅ Usando datos guardados en Profile: $nombreUsuario");
        });
    ...
    try {
      ...
      if (userData != null) {
        ...
        if (resultado != null) {
          ...
          // Guardar la ruta de la imagen local para sincronización entre pantallas
          await prefs.setString('imagen_local_path', imagen.path);
          
          // Actualizar la URL de la imagen para sincronización
          final imagenUrlNueva = 'file://${imagen.path}';
          await prefs.setString('imagen_url', imagenUrlNueva);
          
          // Actualizar nombre de usuario para sincronización
          await prefs.setString('nombre_usuario', nombreUsuario);
          
          print("✅ Imagen actualizada y sincronizada: $imagenUrlNueva");
