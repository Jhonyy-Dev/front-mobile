...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Definir colores segÃºn el estado del switch Dark Mode
    final Color primaryColor = const Color(0xFF4485FD);

    // Aplicar colores segÃºn el estado del switch darkModeEnabled
  ...
  // MÃ©todo para mostrar el modal de cambio de contraseña
  ...
  // MÃ©todo para construir los requisitos de contraseña
  ...
  // MÃ©todo para mostrar el modal de Configuración de Privacidad
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SwitchListTile(
                            ...
                            subtitle: Text(
                              'Ayudanos a mejorar enviando datos anónimos sobre el uso de la aplicación',
                              style: TextStyle(
                                color: secondaryTextColor,
                                fontSize: 14,
                              ),
